...
-- ============================================================
MERGE INTO soutra_statut_client sc
...
-- 2. TYPES DE COMPTE
-- ============================================================
MERGE INTO soutra_type_compte tc
...
-- ============================================================
MERGE INTO soutra_type_transaction tt
...
-- ============================================================
MERGE INTO soutra_statut_credit sc
...
-- ============================================================
MERGE INTO soutra_produit_credit pc
...
-- ============================================================
MERGE INTO soutra_produit_epargne pe
...
-- ============================================================
MERGE INTO soutra_type_canal tc
...
-- ============================================================
MERGE INTO soutra_statut_envoi se
