...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Requête de changement de statut d'un compte")
public class ChangementStatutCompteRequestDTO {
    ...
    @Schema(description = "Motif du changement de statut (optionnel, max 500 caractères)", example = "Suspicion d'activité frauduleuse")
