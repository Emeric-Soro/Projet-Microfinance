...
INSERT INTO utilisateur (id_user, nom_utilisateur, mot_de_passe_hash, email, id_client, actif, second_facteur_active, otp_tentatives_restantes, mot_de_passe_modifie_le, identifiants_expirent_le)
VALUES (999, 'demo.admin', '$2a$10$dummyhashwillbereplaced', 'demo.admin@microfin.local', 999, 1, 0, 0, SYSTIMESTAMP, SYSTIMESTAMP + NUMTODSINTERVAL(90, 'DAY'));
COMMIT;
